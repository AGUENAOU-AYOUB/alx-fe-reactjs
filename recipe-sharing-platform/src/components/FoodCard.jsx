function FoodCard({ image, title, summary }) {
  return (
    <article className="group w-[90%] sm:w-[220px] md:w-[280px] lg:w-[320px] bg-[#1B4332] rounded-2xl overflow-hidden shadow transition-all duration-500 ease-in-out transform-gpu hover:-translate-y-4 hover:shadow-lg mx-auto ">
